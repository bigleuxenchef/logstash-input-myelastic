...
#########
  ...
  def push_hit(hit, output_queue)
    ...
    logger.info("<<<<<< .  ER . >>>>>>>sql_last_value #{sql_last_value} respond tpo time : #{sql_last_value.respond_to?:Time} timestamp : #{sql_last_value.respond_to?:Timestamp} String :#{sql_last_value.respond_to?:String} ")
